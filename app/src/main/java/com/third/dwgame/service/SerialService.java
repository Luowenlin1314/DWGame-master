package com.third.dwgame.service;
...
import com.third.dwgame.manager.SerialManager;
import com.third.dwgame.utils.DWConstant;
import com.third.dwgame.utils.SerialUtils;
import com.third.dwgame.utils.YTBusProData;

import java.io.File;
import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import static com.third.dwgame.DWGameV2Activity.USEING_PORT;
...
//        doSomething(SerialUtils.bytes2HexString(data));
    ...
    private static final String PRO_HEAD_2 = "5AA505";
    private static final String PRO_HEAD_3 = "5AA506";
    private void doDWSomething(String buf) {
        ...
        if (reciverString.length() >= LIMIT_LENGTH) {
            ...
            }else if(reciverString.contains(PRO_HEAD_3)){
                //显示的风速
                String showData = reciverString.substring(12, 18);
                reciverString = reciverString.substring(18,reciverString.length());
                Log.e("ZM","showData = " + showData);
            }
    ...
    private synchronized void toHandler(String data){
        Log.e("ZM","data = " + data);
        Intent intent = new Intent(DWConstant.INTENT_DW_COM);
